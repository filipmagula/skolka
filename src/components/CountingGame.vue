<template>
  <div class="">
    ...
    <div class="w-full flex flex-row flex-wrap p-2">
      <div v-for="(option, index) in options" :key="index" class="basis-1/2 p-2" @click="checkAnswer(option)" :disabled="answered">
        <div class="flex flex-col h-28 border border-black rounded-lg justify-center bg-transblack" :class="getClass(option)">
